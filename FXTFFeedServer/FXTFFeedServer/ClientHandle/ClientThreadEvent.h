#if !defined ClientThreadEvent_H 
#define ClientThreadEvent_H
...
public:
	...
	ClientThreadEvent(string eventName="",PAPCFUNC _pfnAPC=NULL,BOOL queueUserAPC=FALSE);
    virtual ~ClientThreadEvent();
