#ifndef FXCMUSApplicationMessaging_H
#define FXCMUSApplicationMessaging_H
...
class FXCMUSApplicationMessaging : public MessageCracker, public Application
{
private:
	// Members
...
public:
	FXCMUSApplicationMessaging(FXCMUSFixController* aFXCMUSFixController);
	~FXCMUSApplicationMessaging();
