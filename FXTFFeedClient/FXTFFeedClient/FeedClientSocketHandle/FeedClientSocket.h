#ifndef FeedClientSocket_H
#define FeedClientSocket_H
...
public:
    ...
    FeedClientSocket(int);                       // given a port number, create a socket

    virtual ~FeedClientSocket()
    {
		#ifdef WINDOWS_XP
...
public:
	...
	// show the socket 
	friend ostream& operator<<(ostream&,FeedClientSocket&);
...
class FeedClientTcpSocket : public FeedClientSocket
{
...
public:
	...
	*/
	...
	FeedClientTcpSocket(int portId) : FeedClientSocket(portId) { };
