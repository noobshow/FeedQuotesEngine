...
#ifndef FeedClientHostInfo_H
#define FeedClientHostInfo_H
...
enum hostTypeClient {NAMEClient, ADDRESSClient};

class FeedClientHostInfo
{
...
public:
    ...
    FeedClientHostInfo(string& hostName, hostTypeClient type);
